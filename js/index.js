...
// 2nd task:
// Load the students from the localStorage to studentsArr so we get them in the 
// temporary storage and save them again instead of overwrite the data in the local storage
